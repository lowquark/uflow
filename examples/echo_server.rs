...
fn main() {
    ...
    // Create a host object bound to localhost on port 8888, with a maximum of 8 concurrent connections
    let mut host = uflow::Host::bind("127.0.0.1:8888", 8, params).unwrap();
